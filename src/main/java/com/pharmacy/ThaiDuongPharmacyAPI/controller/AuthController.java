...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<OtpResponse>> requestForgotPasswordOtp(@Valid @RequestBody ForgotPasswordRequest request) {
    ...
    public ResponseEntity<ApiResponse<Object>> verifyForgotPasswordOtp(@Valid @RequestBody ForgotPasswordVerifyOtpRequest request) {
    ...
    public ResponseEntity<ApiResponse<OtpResponse>> requestOtp(@Valid @RequestBody RegisterRequest request) {
    ...
    public ResponseEntity<ApiResponse<RegisterResponse>> verifyOtp(@Valid @RequestBody RegisterVerifyOtpRequest request) {
